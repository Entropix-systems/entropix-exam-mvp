...
const platform: CurrentUserResponse = { sessionId: 'bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb', name: 'Platform Administrator', email: 'platform.admin@example.test', institutions: [], context: { kind: 'PLATFORM', userId: 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', role: 'PLATFORM_ADMIN' } }
