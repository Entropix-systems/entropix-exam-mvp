...
export const demoCredentials: readonly Credential[] = [
  ...
  { scenario: 'Northstar tenant administration', email: 'institution.admin@northstar.example.test', tenantSlug: 'northstar-college', roles: [{ role: 'INSTITUTION_ADMIN' }], expectedRole: 'INSTITUTION_ADMIN', expectedRoute: '/academics' },
  { scenario: 'Cedar tenant administration', email: 'institution.admin@cedar.example.test', tenantSlug: 'cedar-school', roles: [{ role: 'INSTITUTION_ADMIN' }], expectedRole: 'INSTITUTION_ADMIN', expectedRoute: '/academics' },
  ...
  { scenario: 'Department-scoped review', email: 'department.admin@northstar.example.test', tenantSlug: 'northstar-college', roles: [{ role: 'DEPARTMENT_ADMIN', departmentCode: 'CSE' }], expectedRole: 'DEPARTMENT_ADMIN', expectedRoute: '/evaluation' },
  { scenario: 'Assigned marks entry', email: 'ananya.iyer@northstar.example.test', tenantSlug: 'northstar-college', roles: [{ role: 'FACULTY', departmentCode: 'CSE' }], expectedRole: 'FACULTY', expectedRoute: '/evaluation', profile: { kind: 'faculty', code: 'NSF001' } },
  { scenario: 'Assigned conduct', email: 'nisha.rao@cedar.example.test', tenantSlug: 'cedar-school', roles: [{ role: 'INVIGILATOR' }, { role: 'FACULTY', departmentCode: 'SCHOOL' }], expectedRole: 'INVIGILATOR', expectedRoute: '/conduct', profile: { kind: 'faculty', code: 'CSF001' } },
